...
public:
	...
	virtual const Vector3D& GetRenderOrigin( void ) = 0;
	virtual const Vector3D& GetRenderAngles( void ) = 0;
	...
	int				numAttachments;
	Vector3D			attachment[ MAX_BEAM_ENTS ];
	Vector3D			delta;
...
public:
	...
	virtual void	CreateBeamEntPoint( int	nStartEntity, const Vector3D* pStart, int nEndEntity, const Vector3D* pEnd,
		int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b ) = 0;
	virtual void	CreateBeamPoints( Vector3D& start, Vector3D& end, int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b ) = 0;
	...
	virtual void	CreateBeamRingPoint( const Vector3D& center, float start_radius, float end_radius, int modelIndex, int haloIndex, float haloScale,
		float life, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
		float brightness, float speed, int startFrame,
		float framerate, float r, float g, float b, int flags = 0 ) = 0;
	virtual void	CreateBeamCirclePoints( int type, Vector3D& start, Vector3D& end,
